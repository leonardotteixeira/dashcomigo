...
export function QuestionarioRisco({ onComplete }: QuestionarioRiscoProps) {
  ...
  return (
    <div className="space-y-6">
      {step < 2 && (
        <div>
          <h3 className="text-lg font-bold text-[#0E3B2E] mb-4">{questions[step].title}</h3>
              ...
              <button
                ...
                className={`w-full p-4 rounded-lg border transition-all text-left ${
                  questions[step].current === option.value
                    ...
                    : 'bg-[#F9FAFB] border-[rgba(20,18,15,0.13)] hover:border-[#28A263]/30'
                }`}
              >
                <p className="font-medium text-[#0E3B2E]">{option.label}</p>
              </button>
            ))}
          </div>
        </div>
      ...
      {step === 2 && (
        <div>
          <h3 className="text-lg font-bold text-[#0E3B2E] mb-4">Qual seu horizonte de investimento?</h3>
          <div className="space-y-3">
            <Label className="text-[#0E3B2E] font-medium">Anos até precisar do dinheiro</Label>
            <input
              type="number"
              min="1"
              max="50"
              ...
              placeholder="Ex: 10"
              className="w-full p-3 rounded-lg border border-[rgba(20,18,15,0.13)] text-[#0E3B2E] text-lg focus:outline-none focus:ring-2 focus:ring-[#28A263]/20"
            />
      ...
      <div className="flex gap-3 pt-4">
        {step > 0 && (
          <Button
            type="button"
            className="flex-1 bg-white text-[#0E3B2E] border border-[rgba(20,18,15,0.13)] hover:bg-[#F9FAFB]"
