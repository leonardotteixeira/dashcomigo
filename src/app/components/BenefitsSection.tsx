    ...
    <section className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold text-[#001529] mb-4">
            Por que usar nosso{" "}
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {benefits.map((benefit, index) => {
            ...
            return (
              <div
                key={index}
                className="p-6 bg-white rounded-3xl border border-[#E5E7EB] hover:border-[#28A263]/30 transition-all duration-300 hover:-translate-y-1 group shadow-sm"
              >
                ...
                <h3 className="text-lg font-bold text-[#001529] mb-3">
                  {benefit.title}
                </h3>
        ...
        {/* Stats Section */}
        <div className="mt-20 bg-white rounded-[32px] p-12 border border-[#E5E7EB] relative overflow-hidden shadow-sm">
          {/* Glow inside stats */}
