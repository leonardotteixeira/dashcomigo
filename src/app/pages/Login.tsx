...
function GoogleLoginButton({ loading, loginWithGoogle, navigate }: {
  loading: boolean;
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      if (msg.includes("popup") || msg.includes("closed")) {
        toast.error("Janela fechada. Tente novamente.");
      } else {
        toast.error(msg || "Erro ao entrar com Google. Tente novamente.");
      }
    } finally {
