...
export function Funcionalidades() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white border-b border-border">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            <Link to="/" className="text-[#0E3B2E]/70 hover:text-[#0E3B2E] transition-colors font-semibold">
              Home
            </Link>
            <a href="/#beneficios" className="text-[#0E3B2E]/70 hover:text-[#0E3B2E] transition-colors font-semibold">
              Benefícios
            </a>
            <a href="/#planos" className="text-[#0E3B2E]/70 hover:text-[#0E3B2E] transition-colors font-semibold">
              Planos
            </a>
          </div>
          ...
          <div className="flex items-center gap-3">
            <Link
              to="/login"
              className="text-[#0E3B2E] font-semibold hover:text-[#0E3B2E] transition-colors"
            >
              Entrar
            </Link>
            <Link
              to="/login"
              className="bg-[#0E3B2E] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[#002a50] transition-all"
            >
              Abrir conta
            </Link>
          </div>
      ...
      {/* Hero */}
      <section className="pt-32 pb-20 px-6 bg-gradient-to-br from-[#0E3B2E] via-[#0E3B2E] to-[#0E3B2E]">
      ...
      {/* Main Features Grid */}
      <section className="py-20 px-6 bg-[#F4EFE6]">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="rounded-xl p-10 shadow-lg border border-transparent hover:border-[#0E3B2E]/20 hover:shadow-xl transition-all"
            >
              <div className="w-16 h-16 rounded-2xl bg-[#0E3B2E]/10 flex items-center justify-center mb-6">
                <TrendingUp className="w-8 h-8 text-[#0E3B2E]" />
              </div>
              <h3 className="font-extrabold text-[#0E3B2E] mb-4 text-3xl">Fluxo de Caixa</h3>
              <p className="text-[#0E3B2E]/60 text-lg leading-relaxed mb-6">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3 text-[#0E3B2E]">
                  <div className="w-2 h-2 rounded-full bg-[#0E3B2E] mt-2" />
            ...
            >
              <div className="w-16 h-16 rounded-2xl bg-[#0E3B2E]/10 flex items-center justify-center mb-6">
                <PieChart className="w-8 h-8 text-[#0E3B2E]" />
              </div>
              <h3 className="font-extrabold text-[#0E3B2E] mb-4 text-3xl">Relatórios Visuais</h3>
              <p className="text-[#0E3B2E]/60 text-lg leading-relaxed mb-6">
            ...
            >
              <div className="w-16 h-16 rounded-2xl bg-[#0E3B2E]/10 flex items-center justify-center mb-6">
                <Clock className="w-8 h-8 text-[#0E3B2E]" />
              </div>
              <h3 className="font-extrabold text-[#0E3B2E] mb-4 text-3xl">Contas a Pagar e Receber</h3>
              <p className="text-[#0E3B2E]/60 text-lg leading-relaxed mb-6">
            ...
            >
              <div className="w-16 h-16 rounded-2xl bg-[#0E3B2E]/10 flex items-center justify-center mb-6">
                <DollarSign className="w-8 h-8 text-[#0E3B2E]" />
              </div>
              <h3 className="font-extrabold text-[#0E3B2E] mb-4 text-3xl">Orçamentos</h3>
              <p className="text-[#0E3B2E]/60 text-lg leading-relaxed mb-6">
            ...
            >
              <div className="w-16 h-16 rounded-2xl bg-[#0E3B2E]/10 flex items-center justify-center mb-6">
                <FileText className="w-8 h-8 text-[#0E3B2E]" />
              </div>
              <h3 className="font-extrabold text-[#0E3B2E] mb-4 text-3xl">Gestão de Clientes</h3>
              <p className="text-[#0E3B2E]/60 text-lg leading-relaxed mb-6">
            ...
            >
              <div className="w-16 h-16 rounded-2xl bg-[#0E3B2E]/10 flex items-center justify-center mb-6">
                <BarChart3 className="w-8 h-8 text-[#0E3B2E]" />
              </div>
              <h3 className="font-extrabold text-[#0E3B2E] mb-4 text-3xl">Simuladores Financeiros</h3>
              <p className="text-[#0E3B2E]/60 text-lg leading-relaxed mb-6">
      ...
      <section className="py-32 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="font-extrabold text-[#0E3B2E] mb-4 text-5xl">
              Tudo conectado
            </h2>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6, delay: 0.2 }}
            className="rounded-xl p-12 border border-[rgba(20,18,15,0.13)] shadow-lg"
          >
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="w-20 h-20 rounded-2xl bg-[#0E3B2E]/10 flex items-center justify-center mx-auto mb-4">
                  <LinkIcon className="w-10 h-10 text-[#0E3B2E]" />
                </div>
                <h3 className="font-bold text-[#0E3B2E] mb-2 text-xl">Dados Sincronizados</h3>
              ...
              <div className="text-center">
                <div className="w-20 h-20 rounded-2xl bg-[#0E3B2E]/10 flex items-center justify-center mx-auto mb-4">
                  <TrendingUp className="w-10 h-10 text-[#0E3B2E]" />
                </div>
                <h3 className="font-bold text-[#0E3B2E] mb-2 text-xl">Visão Unificada</h3>
                <p className="text-[#0E3B2E]/60">
              ...
              <div className="text-center">
                <div className="w-20 h-20 rounded-2xl bg-[#0E3B2E]/10 flex items-center justify-center mx-auto mb-4">
                  <FileText className="w-10 h-10 text-[#0E3B2E]" />
                </div>
                <h3 className="font-bold text-[#0E3B2E] mb-2 text-xl">Relatórios Integrados</h3>
                <p className="text-[#0E3B2E]/60">
      ...
      {/* CTA */}
      <section className="py-32 px-6 bg-gradient-to-br from-[#0E3B2E] to-[#0E3B2E]">
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
        ...
        >
          ...
          <Link
            to="/login"
            className="inline-flex items-center gap-3 bg-white text-[#0E3B2E] px-10 py-5 rounded-lg font-bold hover:bg-white/90 transition-all shadow-2xl text-lg"
          >
            Começar agora
      ...
      {/* Footer */}
      <footer className="bg-[#0E3B2E] border-t border-white/10 py-12 px-6">
        <div className="max-w-7xl mx-auto">
