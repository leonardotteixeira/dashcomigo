      ...
      <div className="w-full max-w-md text-center">
        ...
        {status === "loading" && (
          <>
            ...
            <h1 className="text-2xl font-bold text-[#001529] mb-2">Verificando seu e-mail...</h1>
        ...
        {status === "error" && (
          <>
            ...
            <h1 className="text-2xl font-bold text-[#001529] mb-2">Link inválido ou expirado</h1>
