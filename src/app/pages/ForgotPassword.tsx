    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center p-6">
        <div className="w-full max-w-md text-center">
          ...
          <h1 className="text-3xl font-bold text-[#0E3B2E] mb-3">Email enviado!</h1>
          ...
          <Link to="/login">
            <Button className="w-full h-12 border border-[#E8EBF1] bg-white text-[#0E3B2E] hover:bg-[#F9FAFB]">
              Voltar para o login
            </Button>
          </Link>
        </div>
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        <Link
          to="/login"
          className="inline-flex items-center text-[rgba(0,21,41,0.5)] hover:text-[#0E3B2E] mb-8 transition-colors"
        >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-[#0E3B2E] mb-2">Esqueceu a senha?</h1>
        ...
        <Card className="p-8 border border-[#E8EBF1] bg-white shadow-sm">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <Label htmlFor="email" className="flex items-center gap-2 mb-2 text-[#0E3B2E]">
